...
4. "대여 신청"이란 이용자가 상품/서비스 이용 의사를 표시하고 확인 절차를 거쳐 거래가 성립되는 행위를 말합니다.
...
제5조 (서비스 제공 및 운영)
1. 서비스는 사무기기 렌탈 상품 탐색, 대여 신청, 상담 연결, 결제 지원 등의 기능을 제공합니다.
2. 서비스 범위와 운영 방식은 정책, 기술적 사정, 파트너 운영 사정에 따라 변경될 수 있습니다.

제6조 (대여 신청, 계약의 성립 및 플랫폼의 지위)
1. 대여 신청 요청은 파트너 수락 또는 확인 절차 완료 시점에 확정됩니다.
