            ...
            <div className="relative py-24 bg-slate-900 text-white overflow-hidden">
                ...
                <Container className="relative z-20 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ lineHeight: 1.4 }}>
                        고객의 성공적인 행사를 위한<br />
                        <span className="text-[#006CA3]">최고의 파트너</span>
                    </h1>
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6 break-keep">
                                ABOUT <span className="text-[#006CA3]">휴먼파트너</span>
                            </h2>
                        ...
                        <div className="flex-1 grid grid-cols-2 gap-4">
                            <div className="bg-slate-50 p-6 rounded-2xl text-center hover:shadow-lg transition-all border border-slate-100 flex flex-col items-center justify-center">
                                <LayoutTemplate className="w-10 h-10 text-[#006CA3] mb-3" />
                            ...
                            <div className="bg-slate-50 p-6 rounded-2xl text-center hover:shadow-lg transition-all border border-slate-100 flex flex-col items-center justify-center">
                                <Network className="w-10 h-10 text-[#006CA3] mb-3" />
            ...
            <section className="py-20 bg-slate-50">
                <Container>
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500">휴먼파트너가 제공하는 핵심 서비스 분야입니다.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all group">
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 group-hover:text-[#006CA3] transition-colors">행사 장비 렌탈</h3>
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all group">
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 group-hover:text-[#006CA3] transition-colors">공간 연출 및 기획</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all group">
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 group-hover:text-[#006CA3] transition-colors">현장 운영 지원</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">
